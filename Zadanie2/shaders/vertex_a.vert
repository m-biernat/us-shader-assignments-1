...
void main()
{
	if (vPosition.x >= -1.0f && vPosition.x < -0.33f)
	{
		if (vPosition.y <= 1.0f && vPosition.y > 0.33f)
			color = vec4(0.0f, 0.0f, 1.0f, 1.0f); // Region 0.0 - niebieski
		else if (vPosition.y >= -0.33f && vPosition.y <= 0.33f)
			color = vec4(0.0f, 1.0f, 0.0f, 1.0f); // Region 0.1 - zielony
		else if (vPosition.y < -0.33f && vPosition.y >= -1.0f)
			color = vec4(1.0f, 0.0f, 0.0f, 1.0f); // Region 0.2 - czerwony
	}	
	else if (vPosition.x >= -0.33f && vPosition.x <= 0.33f)
	{
		if (vPosition.y <= 1.0f && vPosition.y > 0.33f)
	...
	else if (vPosition.x > 0.33f && vPosition.x <= 1.0f)
	{
		if (vPosition.y <= 1.0f && vPosition.y > 0.33f)
